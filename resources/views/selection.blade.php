                ...
                <div style="border-radius: 15px;" class="col-lg-8 col-md-8 bg-white">
                    <div class="login-fancy pb-40 clearfix">
                        ...
                        <div class="form-inline mb-30">
                            ...
                            <a class="btn btn-default col-lg-3" title="ولي امر" href="{{route('login.show','perent')}}">
                        ...
                        <!-- قائمة النصية للاختيار كبديل أو للعرض -->
{{--                        <h4 class="mb-20">أو اختر نوع المستخدم:</h4>--}}
{{--                        <ul>--}}
{{--                            <li><a href="{{ route('login.show', 'student') }}">طالب</a></li>--}}
{{--                            <li><a href="{{ route('login.show', 'teacher') }}">معلم</a></li>--}}
{{--                            <li><a href="{{ route('login.show', 'perent') }}">ولي أمر</a></li>--}}
{{--                            <li><a href="{{ route('login.show', 'web') }}">ادمن</a></li>--}}
{{--                        </ul>--}}
